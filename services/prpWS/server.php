...
require_once('models/prpWS.php');

//require_once('class.complextypedemo.php');
// Initialize the PhpWsdl class
require_once(LIB_PATH.'php-wsdl/class.phpwsdl.php');
$soap           = PhpWsdl::CreateInstance(
        ...
        'models/prpWS.php',), null, // The name of the class that serves the webservice will be determined by PhpWsdl
